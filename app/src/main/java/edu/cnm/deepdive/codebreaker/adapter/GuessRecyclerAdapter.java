...
public class GuessRecyclerAdapter extends RecyclerView.Adapter<Holder> {
  ...
  public GuessRecyclerAdapter(@NonNull Context context, @NonNull Map<Character, Integer> colorValueMap, @NonNull Map<Character, String> colorLabelMap) {
  ...
  // Allows us to inflate the binding.
  // The ViewGroup, a theme applies and element and all the styles is contains.
  @NonNull
  @Override
